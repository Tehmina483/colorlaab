...
gsap.registerPlugin(ScrollTrigger);
gsap.to(".project_container_content_1" ,{
  opacity:1,
  y:-50,
  duration:1,
  scrollTrigger:".project_container_content_1"
})
gsap.registerPlugin(ScrollTrigger);
gsap.to(".project_container_content_2" ,{
  opacity:1,
  y:-50,
  duration:1,
  scrollTrigger:".project_container_content_2"
})
gsap.registerPlugin(ScrollTrigger);
